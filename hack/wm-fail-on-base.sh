...
# WM-9 — pause must preserve tasks when snapshots cannot be configured.
...
check WM-9 TestWM9PausePreflight_MissingRegistryPreservesRunningTask run_go kubernetes ./internal/controller TestWM9PausePreflight_MissingRegistryPreservesRunningTask
